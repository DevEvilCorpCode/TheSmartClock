...
package com.evilcorpcode.thesmartclock.stopwatch;
...
import com.evilcorpcode.thesmartclock.chronometer.ChronometerDelegate;
import com.evilcorpcode.thesmartclock.chronometer.ChronometerNotificationService;
import com.evilcorpcode.thesmartclock.stopwatch.data.AsyncLapsTableUpdateHandler;
import com.evilcorpcode.thesmartclock.stopwatch.ui.StopwatchFragment;
import com.evilcorpcode.thesmartclock.util.ContentIntentUtils;
...
public class StopwatchNotificationService extends ChronometerNotificationService {
    ...
    public static final String ACTION_ADD_LAP = "com.evilcorpcode.thesmartclock.stopwatch.action.ADD_LAP";
    public static final String ACTION_UPDATE_LAP_TITLE = "com.evilcorpcode.thesmartclock.stopwatch.action.UPDATE_LAP_TITLE";

    public static final String EXTRA_LAP_NUMBER = "com.evilcorpcode.thesmartclock.stopwatch.extra.LAP_NUMBER";
