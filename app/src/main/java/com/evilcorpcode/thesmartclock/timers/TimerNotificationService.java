...
public class TimerNotificationService extends ChronometerNotificationService {
    ...
    private static final String ACTION_CANCEL_NOTIFICATION = "com.evilcorpcode.thesmartclock.timers.action.CANCEL_NOTIFICATION";
    public static final String ACTION_ADD_ONE_MINUTE = "com.evilcorpcode.thesmartclock.timers.action.ADD_ONE_MINUTE";

    public static final String EXTRA_TIMER = "com.evilcorpcode.thesmartclock.timers.extra.TIMER";
    private static final String EXTRA_CANCEL_TIMER_ID = "com.evilcorpcode.thesmartclock.timers.extra.CANCEL_TIMER_ID";
