...
import com.evilcorpcode.thesmartclock.timers.CreateTimerActivity;
...
import com.evilcorpcode.thesmartclock.timers.data.TimersListCursorLoader;

import static butterknife.ButterKnife.findById;
import static com.evilcorpcode.thesmartclock.util.ConfigurationUtils.getOrientation;
...
public class TimersFragment extends RecyclerViewFragment<Timer, TimerViewHolder, TimerCursor, TimersCursorAdapter> {
    ...
    public static final String EXTRA_SCROLL_TO_TIMER_ID = "com.evilcorpcode.thesmartclock.timers.extra.SCROLL_TO_TIMER_ID";
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode != Activity.RESULT_OK || data == null)
            return;
        // TODO: From CreateTimerActivity, pass back the Timer as a parcelable and
        // retrieve it here directly.
        int hour = data.getIntExtra(CreateTimerActivity.EXTRA_HOUR, -1);
        int minute = data.getIntExtra(CreateTimerActivity.EXTRA_MINUTE, -1);
        int second = data.getIntExtra(CreateTimerActivity.EXTRA_SECOND, -1);
        String label = data.getStringExtra(CreateTimerActivity.EXTRA_LABEL);
        boolean startTimer = data.getBooleanExtra(CreateTimerActivity.EXTRA_START_TIMER, false);
        // TODO: Timer's group?
    ...
    public void onFabClick() {
        Intent intent = new Intent(getActivity(), CreateTimerActivity.class);
