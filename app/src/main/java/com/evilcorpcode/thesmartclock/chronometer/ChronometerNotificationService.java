...
package com.evilcorpcode.thesmartclock.chronometer;
...
public abstract class ChronometerNotificationService extends Service {
    public static final String ACTION_START_PAUSE = "com.evilcorpcode.thesmartclock.timers.action.START_PAUSE";
    public static final String ACTION_STOP = "com.evilcorpcode.thesmartclock.timers.action.STOP";

    public static final String EXTRA_ACTION_ID = "com.evilcorpcode.thesmartclock.extra.ID";
