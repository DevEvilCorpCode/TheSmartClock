...
package com.evilcorpcode.thesmartclock.ringtone.playback;
...
public class AlarmRingtoneService extends RingtoneService<Alarm> {
    ...
    private static final String ACTION_SNOOZE = "com.evilcorpcode.thesmartclock.ringtone.action.SNOOZE";
    private static final String ACTION_DISMISS = "com.evilcorpcode.thesmartclock.ringtone.action.DISMISS";
