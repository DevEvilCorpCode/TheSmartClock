...
import com.evilcorpcode.thesmartclock.ringtone.RingtoneActivity;
...
public abstract class RingtoneService<T extends Parcelable> extends Service {
    ...
    // public okay
    public static final String ACTION_NOTIFY_MISSED = "com.evilcorpcode.thesmartclock.ringtone.action.NOTIFY_MISSED";
