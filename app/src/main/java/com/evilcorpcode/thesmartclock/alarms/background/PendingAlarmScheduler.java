...
import static com.evilcorpcode.thesmartclock.util.Preconditions.checkNotNull;
...
public class PendingAlarmScheduler extends BroadcastReceiver {
    ...
    public static final String EXTRA_ALARM_ID = "com.evilcorpcode.thesmartclock.alarms.background.PendingAlarmScheduler.extra.ALARM_ID";
