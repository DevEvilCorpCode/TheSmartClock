...
package com.evilcorpcode.thesmartclock.alarms.background;
...
public class UpcomingAlarmReceiver extends BroadcastReceiver {
    ...
    private static final String ACTION_DISMISS_NOW = "com.evilcorpcode.thesmartclock.action.DISMISS_NOW";

    public static final String ACTION_CANCEL_NOTIFICATION = "com.evilcorpcode.thesmartclock.action.CANCEL_NOTIFICATION";
    public static final String ACTION_SHOW_SNOOZING = "com.evilcorpcode.thesmartclock.action.SHOW_SNOOZING";
    public static final String EXTRA_ALARM = "com.evilcorpcode.thesmartclock.extra.ALARM";
