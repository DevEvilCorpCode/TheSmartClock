...
import com.evilcorpcode.thesmartclock.alarms.data.AlarmCursor;
import com.evilcorpcode.thesmartclock.alarms.data.AlarmsListCursorLoader;
import com.evilcorpcode.thesmartclock.alarms.data.AsyncAlarmsTableUpdateHandler;
...
import static com.evilcorpcode.thesmartclock.util.FragmentTagUtils.makeTag;
...
public class AlarmsFragment extends RecyclerViewFragment<Alarm, BaseAlarmViewHolder, AlarmCursor,
    ...
    public static final String EXTRA_SCROLL_TO_ALARM_ID = "com.evilcorpcode.thesmartclock.alarms.extra.SCROLL_TO_ALARM_ID";
