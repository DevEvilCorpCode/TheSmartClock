...
package com.evilcorpcode.thesmartclock.settings;
...
public class SettingsActivity extends BaseActivity {
    public static final String EXTRA_THEME_CHANGED = "com.evilcorpcode.thesmartclock.settings.extra.THEME_CHANGED";
